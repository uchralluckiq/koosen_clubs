...
export default function Filter({ filters, setFilters }) {
  return (
    ...
    <div className="flex w-full h-1/10 px-4 sm:px-6 lg:px-10 py-4 sm:py-6 justify-around">
      <div className="flex gap-2 sm:gap-3 lg:gap-4 justify-center items-center flex-wrap">
        <select
          className="rounded-2xl py-2 px-3 sm:px-4 bg-gray-800 text-sm sm:text-base"
          value={filters.year || ""}
          onChange={(e) =>
